...
<head>
    ...
    <style>
        ...
        #bookmarkDelete tr:nth-child(even){background-color: #f2f2f2;}

        #bookmarkDelete tr:hover {background-color: #ddd;}
...
<table id="bookmarkDelete">
    <tr>
        <th>북마크 이름</th>
        <td id="bookmarkName"><%= request.getParameter("bookmarkName") %> </td>
    </tr>
    <tr>
        <th>와이파이명</th>
        <td id="wifiName"><%= request.getParameter("wifiName") %></td>
    </tr>
    <tr>
        <th>등록일자</th>
        <td id="regiDate"><%= request.getParameter("regiDate") %></td>
    </tr>
    <tr>
