...
public class GetOpenAPI extends HttpServlet {
    ...
    private String baseUrl = "http://openapi.seoul.go.kr:8088/7648616b6877307736356369546258/json/TbPublicWifiInfo";
    ...
    void storeInDatabase(List<JsonObject> records) {
        ...
        try {
            ...
            // Loop through the records list and insert data into the table
