...
public class ApiExplorer {
    ...
    public static void InfoOpenAPI() throws IOException{
        //http://openapi.seoul.go.kr:8088/7648616b6877307736356369546258/xml/TbPublicWifiInfo/1/20
        StringBuilder urlBuilder = new StringBuilder("http://openapi.seoul.go.kr:8088"); /*URL*/
        urlBuilder.append("/" +  URLEncoder.encode("7648616b6877307736356369546258","UTF-8") ); /*인증키 (sample사용시에는 호출시 제한됩니다.)*/
